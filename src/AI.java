...
public class AI extends Board {
    ...
    final int FiveInARow = 100;
    final int FourInARow = 50;
    final int ThreeInARow = 20;
    final int TwoInARow = 5;
    final int OneInARow = 1;
    final int OpponentFiveInARow = -100;
    final int OpponentFourInARow = -50;
    final int OpponentThreeInARow = -20;
    final int OpponentTwoInARow = -5;
    final int OpponentOneInARow = 1;
    ...
    private String miniMax(int level, int player) { //player1 = opponent, player2 = AI
        return "hh";
    }

    public String AIMove() {
        int AIscore = -10000; //seeks to maximize;
        int opponentScore = 10000; //seeks to minimize
        return "F5";
